...
updatemovestate()
{
    ...
    if ( self.movestate == "follow" )
    {
        ...
        {
            var_9 = 1;
            var_10 = findpointnearowner();
            var_11 = spawn( "trigger_radius", self.owner.origin, 0, 256, 256 );
            var_12 = getnodesintrigger( var_11 );
            ...
            while ( var_9 == 1 )
            {
                ...
                foreach ( var_14 in level.instinctdogs )
                {
                    if ( var_9 == 0 )
                    {
                        var_15 = var_14 scragentgetgoalpos();
                ...
                if ( var_9 == 1 )
                {
                    if ( var_12.size > 0 )
                    {
                        for ( var_18 = 0; var_18 < var_12.size; var_18++ )
                        {
                            ...
                            if ( var_19 == 1 )
                            {
                                self scragentsetgoalpos( var_12[var_18].origin );
                                var_9 = 0;
                                break;
                            }
                        }
                    ...
                    {
                        var_23 = getrandomnodedestination( self.owner.origin, self.owner.angles );
                        self scragentsetgoalpos( var_23.origin );
                        var_9 = 0;
                    }
                }
                else
